"""
Módulo para calcular tránsitos planetarios usando un enfoque astronómico avanzado (v2.0).
Esta implementación utiliza búsqueda binaria para encontrar con precisión matemática
los momentos exactos de los aspectos, junto con un sistema de muestreo adaptativo
y detección avanzada de cambios de dirección planetaria.
"""
import json
import time
...
class AstronomicalTransitsCalculatorV2:
    """
    Versión 2.0 del calculador de tránsitos astronómico.
    Implementa búsqueda binaria, muestreo adaptativo avanzado,
    orbes dinámicos universales y detección mejorada de cambios de dirección.
    """
    
    def __init__(self, natal_data: dict):
        """
        Inicializa el calculador de tránsitos astronómico v2.0.

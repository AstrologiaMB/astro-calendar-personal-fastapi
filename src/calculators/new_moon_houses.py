"""
Módulo para generar el análisis de lunas nuevas en casas natales.
"""
import json
import csv

def generate_new_moon_houses_report(natal_file: str, events_file: str, output_file: str = 'natal_lunanueva.csv'):
    """
    Genera un reporte de las lunas nuevas y las casas natales donde ocurren.
    ...
    with open(output_file, 'w', newline='') as f:
        ...
        for moon in new_moons:
            ...
            # Generar descripción
            desc = (f"La luna nueva del día {moon['fecha']} y hora {moon['hora']} "
...
def determinar_casa_natal(signo: str, grado: float, casas: dict, debug: bool = False) -> int:
    """

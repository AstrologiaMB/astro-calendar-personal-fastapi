"""
Módulo para generar el análisis de eclipses lunares en casas natales.
"""
import json
import csv

def generate_lunar_eclipse_houses_report(natal_file: str, events_file: str, output_file: str = 'natal_eclipselunares.csv'):
    """
    Genera un reporte de los eclipses lunares y las casas natales donde ocurren.
    ...
    # Cargar datos de eclipses lunares
    lunar_eclipses = []
    with open(events_file, 'r') as f:
        reader = csv.DictReader(f)
        for row in reader:
            if row['tipo_evento'] == 'Eclipse Lunar':
    ...
    with open(output_file, 'w', newline='') as f:
        ...
        for eclipse in lunar_eclipses:
            ...
            # Generar descripción
            desc = (f"El eclipse lunar {eclipse['tipo'].lower()} del día {eclipse['fecha']} y hora {eclipse['hora']} "
